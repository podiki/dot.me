...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (monokai-theme imenu-list pdf-tools all-the-icons-dired ein all-the-icons which-key use-package spaceline smex smartparens slime-company rainbow-delimiters paradox ox-reveal org2blog org-plus-contrib olivetti neotree multiple-cursors molokai-theme markdown-mode magit latex-pretty-symbols langtool ido-vertical-mode ido-ubiquitous htmlize highlight-symbol highlight-sexp goto-chg fountain-mode flycheck-color-mode-line flx-ido exec-path-from-shell emms define-word company-quickhelp company-math company-auctex color-theme-solarized color-identifiers-mode)))
