...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (which-key use-package spacemacs-theme spaceline smex smartparens slime-company rainbow-delimiters pdf-tools paradox ox-reveal org2blog org-plus-contrib olivetti neotree multiple-cursors monokai-theme molokai-theme markdown-mode magit latex-pretty-symbols langtool imenu-list ido-vertical-mode ido-ubiquitous htmlize highlight-symbol highlight-sexp goto-chg fountain-mode flycheck-color-mode-line flx-ido faceup exec-path-from-shell emms ein define-word company-quickhelp company-math company-auctex color-theme-solarized color-identifiers-mode all-the-icons-dired)))
